...
import { FaUsers, FaBed, FaDoorOpen, FaTags, FaChartBar, FaSearch, FaCalendarCheck, FaIdCard, FaConciergeBell, FaClipboardList, FaBroom, FaTools, FaUtensils, FaBell, FaClipboardCheck } from 'react-icons/fa'
import { useAuth } from '../context/AuthContext'

const ALL_LINKS = [
  { to: '/users', label: 'User Management', icon: <FaUsers />, roles: ['ADMIN'] },
  { to: '/room-types', label: 'Room Types', icon: <FaBed />, roles: ['ADMIN'] },
  { to: '/rooms', label: 'Rooms', icon: <FaDoorOpen />, roles: ['ADMIN', 'FRONTDESK'] },
  { to: '/rate-plans', label: 'Rate Plans', icon: <FaTags />, roles: ['ADMIN', 'REVENUEMANAGER'] },
  { to: '/analytics', label: 'Analytics', icon: <FaChartBar />, roles: ['ADMIN', 'REVENUEMANAGER'] },
  { to: '/book', label: 'Book a Room', icon: <FaSearch />, roles: ['GUEST', 'FRONTDESK', 'ADMIN'] },
  { to: '/my-reservations', label: 'My Reservations', icon: <FaCalendarCheck />, roles: ['GUEST', 'FRONTDESK', 'ADMIN'] },
  ...
  { to: '/maintenance', label: 'Maintenance', icon: <FaTools />, roles: ['HOUSEKEEPING', 'ADMIN'] },
  { to: '/menu', label: 'Menu', icon: <FaUtensils />, roles: ['FBMANAGER', 'ADMIN'] },
  { to: '/orders', label: 'F&B Orders', icon: <FaClipboardList />, roles: ['FBMANAGER', 'ADMIN', 'FRONTDESK'] },
