package com.staynest.housekeeping.config;
 ...
 *   business outcomes, not availability failures — so they never trip the breaker and
 *   propagate unchanged to the callers' existing handling.</li>
 * </ul>
 */
@Configuration
