 ...
 *   business outcomes (e.g. "no such room type"), not availability failures — so they
 *   never trip the breaker and propagate unchanged to the callers' existing
 *   fail-closed validation logic.</li>
 * </ul>
 */
@Configuration
