package com.staynest.fb.config;
 ...
 *   business outcomes (e.g. "no such stay"), not availability failures — so they never
 *   trip the breaker and propagate unchanged to the callers' existing fail-closed
 *   validation logic.</li>
 * </ul>
 */
@Configuration
